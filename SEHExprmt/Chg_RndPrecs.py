...
def paralist_func(item):
    s = csize*esize*qsize    
    cset = [[random.choice(range(csize*esize*qsize))],
            range(int(s*1.0/24.0)),
            range(int(s*2.0/24.0)),
            range(int(s*3.0/24.0)),
            range(int(s*4.0/24.0)),
            range(int(s*5.0/24.0)),
            range(int(s*6.0/24.0)),
            range(int(s*7.0/24.0)),
...
for j,t in enumerate(TEST_SET):
    ...
    pickle.dump(exp_value_lis, open("../rawresults/RndPrecs/exp_value_lis_"+'_'+t,"w"))
    pickle.dump(steady_value_lis, open("../rawresults/RndPrecs/steady_value_lis"+'_'+t,"w"))
    pickle.dump(steady_chg_rate_lis, open("../rawresults/RndPrecs/steady_chg_rate_lis_"+'_'+t,"w"))
    pickle.dump(steady_snd_rate_lis, open("../rawresults/RndPrecs/steady_snd_rate_lis_"+'_'+t,"w"))
    pickle.dump(time_consumed_lis, open("../rawresults/RndPrecs/time_consumed_lis"+'_'+t,"w"))
pickle.dump(TEST_SET, open("../rawresults/RndPrecs/TEST_SET","w"))
pickle.dump(TEST_RANGE, open("../rawresults/RndPrecs/TEST_RANGE","w"))
print "FINISHED!"