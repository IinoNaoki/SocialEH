...
for j,t in enumerate(TEST_SET):        
    ...
    if j==0:
        f = open("./Chg_QSize_result.txt","w")
    else:
        f = open("./Chg_QSize_result.txt","a")
    f.write(" -- "+ t +" --\n")
    f.write(" > Expd_Val:  ")
    ...
    pickle.dump(exp_value_lis, open("../rawresults/QSize/exp_value_lis_"+'_'+t,"w"))
    pickle.dump(steady_value_lis, open("../rawresults/QSize/steady_value_lis"+'_'+t,"w"))
    pickle.dump(steady_chg_rate_lis, open("../rawresults/QSize/steady_chg_rate_lis_"+'_'+t,"w"))
    pickle.dump(steady_snd_rate_lis, open("../rawresults/QSize/steady_snd_rate_lis_"+'_'+t,"w"))
pickle.dump(TEST_SET, open("../rawresults/QSize/TEST_SET","w"))
pickle.dump(TEST_RANGE, open("../rawresults/QSize/TEST_RANGE","w"))
print "FINISHED"