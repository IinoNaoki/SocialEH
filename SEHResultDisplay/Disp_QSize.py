...
grid(True, which="both")
plot(x_axis,steady_chg_r[0],color='red',markerfacecolor='none', markeredgecolor='red', marker='o',markersize=8,label='MDP (Charge)')
plot(x_axis,steady_chg_r[1],color='green',markerfacecolor='none', markeredgecolor='green', marker='^',markersize=8,label='CAS (Charge)')
plot(x_axis,steady_chg_r[2],color='blue',markerfacecolor='none', markeredgecolor='blue', marker='s',markersize=8,label='GRD (Charge)')
...
plot(x_axis,steady_snd_r[0],color='red',markerfacecolor='none', markeredgecolor='red', marker='o',markersize=8,label='MDP (Send)',linestyle='--')
plot(x_axis,steady_snd_r[1],color='green',markerfacecolor='none', markeredgecolor='green', marker='^',markersize=8,label='CAS (Send)',linestyle='--')
plot(x_axis,steady_snd_r[2],color='blue',markerfacecolor='none', markeredgecolor='blue', marker='s',markersize=8,label='GRD (Send)',linestyle='--')
