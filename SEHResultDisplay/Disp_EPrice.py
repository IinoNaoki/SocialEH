...
TEST_SET = pickle.load(open("../rawresults/EPrice/TEST_SET","r"))
x_axis = pickle.load(open("../rawresults/EPrice/TEST_RANGE","r"))
# TEST_SET = ['MDP', 'CAS', 'GREEDY', 'RANDOM', 'THRESHOLDRANDOM']

exp_v, steady_v, steady_chg_r, steady_snd_r = [],[],[],[]
for j,t in enumerate(TEST_SET): 
    exp_v.append(pickle.load(open("../rawresults/EPrice/exp_value_lis_"+'_'+t,"r")))
    steady_v.append(pickle.load(open("../rawresults/EPrice/steady_value_lis"+'_'+t,"r")))
    steady_chg_r.append(pickle.load(open("../rawresults/EPrice/steady_chg_rate_lis_"+'_'+t,"r")))
    steady_snd_r.append(pickle.load(open("../rawresults/EPrice/steady_snd_rate_lis_"+'_'+t,"r")))
...
xlabel('Energy price pattern',fontsize=14)
...
pp = PdfPages('EPrice_figure1.pdf')
...
locs, labels = plt.yticks()
plt.setp(labels, rotation=90)
pp = PdfPages('EPrice_figure3.pdf')
plt.savefig(pp, format='pdf')
pp.close()
...
# locs, labels = plt.yticks()
# plt.setp(labels, rotation=90)
# pp = PdfPages('EPrice_figure4.pdf')
# plt.savefig(pp, format='pdf')
# pp.close()