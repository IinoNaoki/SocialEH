...
TEST_SET = pickle.load(open("../rawresults/RndPrecs/TEST_SET","r"))
x_axis = pickle.load(open("../rawresults/RndPrecs/TEST_RANGE","r"))
...
for j,t in enumerate(TEST_SET): 
    exp_v.append(pickle.load(open("../rawresults/RndPrecs/exp_value_lis_"+'_'+t,"r")))
    steady_v.append(pickle.load(open("../rawresults/RndPrecs/steady_value_lis"+'_'+t,"r")))
    steady_chg_r.append(pickle.load(open("../rawresults/RndPrecs/steady_chg_rate_lis_"+'_'+t,"r")))
    steady_snd_r.append(pickle.load(open("../rawresults/RndPrecs/steady_snd_rate_lis_"+'_'+t,"r")))
    time_con.append(pickle.load(open("../rawresults/RndPrecs/time_consumed_lis"+'_'+t,"r")))
...
locs, labels = plt.yticks()
plt.setp(labels, rotation=90)
pp = PdfPages('RndPrecs_figure4.pdf')
plt.savefig(pp, format='pdf')
pp.close()
...
locs, labels = plt.yticks()
plt.setp(labels, rotation=90)
pp = PdfPages('RndPrecs_figure_time.pdf')
plt.savefig(pp, format='pdf')
pp.close()