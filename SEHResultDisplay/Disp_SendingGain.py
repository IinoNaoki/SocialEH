...
plot(x_axis,exp_v[0],color='red',markerfacecolor='none', markeredgecolor='red', marker='o',markersize=8,label='MDP (Charge)')
plot(x_axis,exp_v[1],color='green',markerfacecolor='none', markeredgecolor='green', marker='^',markersize=8,label='CAS (Charge)')
plot(x_axis,exp_v[2],color='blue',markerfacecolor='none', markeredgecolor='blue', marker='s',markersize=8,label='GRD (Charge)')
